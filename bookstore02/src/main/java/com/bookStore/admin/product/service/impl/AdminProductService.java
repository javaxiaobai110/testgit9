...
public class AdminProductService implements IAdminProductService {
	...
	/*@Override
	public int findProductByConditionCount(Product product, String minprice, String maxprice) {
		// TODO Auto-generated method stub
		return adminProductDao.selectProductByManyConditionCount(product,minprice,maxprice);
	}*/

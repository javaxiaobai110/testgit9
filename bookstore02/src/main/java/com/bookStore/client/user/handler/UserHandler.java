...
public class UserHandler {
	...
	public String register(User user,/* String checkcode,*/ HttpServletRequest request, HttpSession session){
		...
		String value = request.getParameter("checkcode");
		System.out.println(checkcode_session);
		System.out.println(value);
		System.out.println(123456);
		if(checkcode_session.equals(value)){
			System.out.println(45789465);
	...
	public String delOrderById(String id,Integer flag,HttpServletRequest request) {
		if(flag == 1) {
			
			userService.delOrder(id);
			return "/client/user/findOrderByUser.do";
		}else {
			request.setAttribute("message", "订单未付款，不能删除");
			return "/client/user/findOrderByUser.do";
